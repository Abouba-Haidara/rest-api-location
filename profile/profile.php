...
<section id="main_section" class="tinted">
    ...
    <!-- Left Side -->
    <?php //corf_get_panel('profile_left_sidebar') ?>
    ...
    <section id="right_side" class="profile-contr">
        ...
        <div class="info-box" id="friends-box">
            <h3 style="margin-bottom:5px;"><?php //echo number_format($totalFriendsCount) ?> friend<?php //echo $totalFriendsCount != 1 ? 's' : '' ?>
                <a href="/friends.php?user=<?php //echo $userData['userID'] ?>" class="view-all">Afficher Tout </a></h3>
            <?php/*
        ...
        <br/>
        <?php //if($userID == $profileID || corfFriend::isFriend($userID, $profileID)): ?>
            <div class="info-box">
                <h3>
                ...
                <a href="/profile.php?user=<?php //echo $userID ?>">
                    <img src="<?php //echo corfUser::getProfileIcon($userID,$db) ?>" class="postIcons"/></a>
        ...
        <div class="info-box" id="posts-box">
            ...
            foreach($posts as $post){
                echo corf_get_single_post_html($post, $userID);
            }*/
            ?>
            <!-- View More Stream -->
            <div class="clear"></div>
